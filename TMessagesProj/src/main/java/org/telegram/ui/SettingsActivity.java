        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                /*else if (i == askQuestionRow) {
                    ...
                    textCell.setText(LocaleController.getString("ManageEmoticon", R.string.ManageEmoticon), true);
//                    divider.setVisibility(View.VISIBLE);
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "Themegram for Android v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
